...
os.system('sudo ip link set can0 type can bitrate 1000000') # change the value of baud-rate
...
def read_data():
    while True:
        ...
        #************************************************
        distance = msg.data[0] + msg.data[1]*256
        strength = msg.data[2] + msg.data[3]*256
        print("Time stamp:"+str(msg.timestamp))
        print("LiDAR id:0000"+str(msg.arbitration_id))
